...
const Sidebar = ({ collapsed, setCollapsed, userRole = "patient" }) => {
  ...
  return (
    <motion.div
      ...
      className="h-screen bg-white dark:bg-slate-800 border-r border-slate-100 dark:border-slate-700 hidden md:flex flex-col fixed left-0 top-0 z-40 shadow-sm transition-colors duration-200"
    >
      ...
      <div className="p-4 border-t border-slate-50 dark:border-slate-700">
        <button
          ...
          className="flex items-center w-full gap-3 px-3 py-2 text-slate-500 dark:text-slate-400 hover:text-red-500 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors"
        >

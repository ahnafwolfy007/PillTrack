...
const TabsList = ({ className, children, ...props }) => (
    <div
        className={cn(
            "inline-flex h-12 items-center justify-center rounded-lg bg-slate-100 p-1 text-slate-500 w-full",
            className
        )}
        {...props}
    >
    ...
    return (
        <button
            className={cn(
                ...
                isSelected ? "text-slate-950" : "text-slate-500 hover:text-slate-900",
                className
            )}

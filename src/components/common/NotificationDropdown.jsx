  ...
  return (
    ...
    >
      ...
      <Button
        variant="ghost"
        size="icon"
        className="h-6 w-6 shrink-0 text-slate-400 dark:text-slate-500 hover:text-red-500 dark:hover:text-red-400"
        onClick={(e) => {
          e.stopPropagation();
  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="absolute right-0 top-full mt-2 w-80 sm:w-96 bg-white dark:bg-slate-800 rounded-2xl shadow-2xl border border-slate-100 dark:border-slate-700 z-50 overflow-hidden"
      >
        {/* Header */}

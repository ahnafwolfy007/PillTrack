    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl max-w-sm w-full overflow-hidden transition-colors duration-200"
        >
          ...
          <div className="p-6">
            ...
            <div className="space-y-3">
              ...
              <Button
                variant="outline"
                className="w-full gap-2 text-amber-600 dark:text-amber-400 border-amber-200 dark:border-amber-700 hover:bg-amber-50 dark:hover:bg-amber-900/20"
                onClick={handleSkip}
                disabled={loading}
              >
                {loading && action === "skip" ? (

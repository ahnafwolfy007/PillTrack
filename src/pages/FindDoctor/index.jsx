    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          animate={{ opacity: 1, scale: 1, y: 0 }}
          exit={{ opacity: 0, scale: 0.9, y: 20 }}
          className="bg-white dark:bg-slate-800 rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl transition-colors duration-200"
          onClick={(e) => e.stopPropagation()}
        >
          {/* Header */}
    ...
    <motion.div
      ...
      className={cn(
        ...
        isSelected
          ...
          : "border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 hover:border-primary/30 hover:shadow-md",
      )}
    >
      <div
        className={cn(
...
const DoctorCard = ({ doctor, onClick }) => {
  return (
    <motion.div
      ...
      className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-5 cursor-pointer hover:shadow-lg hover:border-primary/20 transition-all"
    >
      <div className="flex items-start gap-4">
  ...
  const fetchInitialData = async () => {
    try {
      ...
      try {
        ...
        console.log(
          "Raw specialties not available, falling back to regular specialties",
        );
      ...
      <div className="bg-gradient-to-r from-primary to-blue-600 text-white py-12 px-4">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-blue-100 mb-8 max-w-2xl mx-auto">
            Search from {stats.totalDoctors || 7000}+ verified doctors across{" "}
            {stats.totalSpecialties || 280}+ specialties in Bangladesh
          </p>

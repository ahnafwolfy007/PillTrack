            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                <div className="bg-blue-50 dark:bg-blue-900/30 rounded-lg p-4">
                  ...
                  <p className="font-medium text-blue-800 dark:text-blue-300 capitalize">
                    {medicine.type || "N/A"}
                  </p>
                </div>
...
const MedBase = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      {/* Header */}
      <header className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-100 dark:border-slate-800 sticky top-0 z-30">
        ...
        >
          ...
          <div className="max-w-2xl mx-auto relative">
            ...
            <Input
              ...
              className="pl-12 h-14 text-lg bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 shadow-lg shadow-slate-200/50 dark:shadow-slate-900/50 rounded-xl dark:text-white"
            />
            {searching && (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {medicines.map((medicine, i) => (
                ...
                >
                  ...
                  >
                    <div className="h-24 bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-700 dark:to-slate-600 p-4 flex items-center justify-center group-hover:from-blue-50 group-hover:to-primary/10 dark:group-hover:from-blue-900/30 dark:group-hover:to-primary/20 transition-colors relative">
                      <Pill
                        size={36}
                        className="text-primary/30 group-hover:scale-110 transition-transform"
                      />
                      {medicine.type && (
                        <span className="absolute top-2 right-2 text-[10px] font-semibold text-primary/60 bg-white/80 dark:bg-slate-800/80 px-2 py-0.5 rounded capitalize">
                          {medicine.type}
                        </span>
                      )}
                    </div>
                    <CardContent className="p-4">
                      ...
                      <h3 className="font-bold text-lg text-slate-800 dark:text-white mt-2 group-hover:text-primary transition-colors line-clamp-1">
                        {medicine.brandName}
                      </h3>
      ...
      <section className="container mx-auto px-4 pb-12">
        <div className="bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-800 rounded-xl p-6 text-center">
          <AlertTriangle
            className="mx-auto text-amber-500 dark:text-amber-400 mb-2"
            size={24}
          />

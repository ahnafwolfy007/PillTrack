...
export const medicineService = {
    ...
    getByManufacturer: async (manufacturerId, page = 0, size = 20) => {
        const response = await api.get(`/medicines/manufacturer/${manufacturerId}`, { 
            params: { page, size } 
        });
        return response.data.data;
    },
...
export const categoryService = {
    ...
    getPaged: async (page = 0, size = 20) => {
        const response = await api.get('/categories/paged', { params: { page, size } });
        return response.data.data;
    },
    getById: async (id) => {
...
export const manufacturerService = {
    ...
    getPaged: async (page = 0, size = 20) => {
        const response = await api.get('/manufacturers/paged', { params: { page, size } });
        return response.data.data;
    },
    getById: async (id) => {
...
export const shopMedicineService = {
    ...
    updateStock: async (id, stockQuantity) => {
        const response = await api.patch(`/shop-medicines/${id}/stock`, { stockQuantity });
        return response.data.data;
    },
    remove: async (id) => {
...
export const cartService = {
    ...
    addItem: async (shopMedicineId, quantity) => {
        const response = await api.post('/cart/items', { shopMedicineId, quantity });
        return { success: true, data: response.data.data };
    },
...
export const adminService = {
    ...
    getPendingShops: async (page = 0, size = 20) => {
        const response = await api.get('/admin/shops/pending', { params: { page, size } });
        return response.data.data;
    },
